...
let tile = {
  ...
  waterproofMethod: [
    ...
    {
      label: "Plumber Provided Rubber Liner",
      value: "Plumber Provided Rubber Liner",
    },
  ...
  showerNicheFraming: [
    ...
    {
      label: "MC Surfaces (not chargeable)",
      value: "MC Surfaces (not chargeable)",
    },
    { label: "Builder", value: "Builder" },
  ],
  cornerSoapDishes: [
    ...
    {
      label: "Standard w/ Niche (extra charge)",
      value: "Standard w/ Niche (extra charge)",
    },
    { label: "Builder", value: "Builder" },
  ],
  showerSeat: [
